...
// 8.5.3: Modify the deck calculator program into a module in the style of 2.4 using namespaces. Don't use any globla using-directives. Keep a record of the mistakes you made. Suggest ways of avoiding those mistakes in the future
